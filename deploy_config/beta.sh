...
firebase functions:config:set email.user="cglove005@gmail.com" email.password="sixnetwork1" email.host="smtp.gmail.com" email.port="465" email.from='"Six network ICO." <noreply@firebase.com>'
